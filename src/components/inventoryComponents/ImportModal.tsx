...
export default function ImportModal({ isOpen, onClose, onImport }: ImportModalProps) {
    ...
    const validateAndTransformItem = (
        ...
        const transformedItem: CreateInventoryItemRequest = {
            ...
            minimum_threshold: parseInt(item.minimum_threshold) || 0,
            maximum_capacity: item.maximum_capacity ? parseInt(item.maximum_capacity) : undefined,
            ...
            reorder_point: item.reorder_point ? parseInt(item.reorder_point) : undefined,
            reorder_quantity: item.reorder_quantity ? parseInt(item.reorder_quantity) : undefined,
        };
