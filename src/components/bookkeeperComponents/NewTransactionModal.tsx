...
export default function NewTransactionModal({
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
        ...
        setForm((prev) => ({
            ...prev, [name]: value, ...(name === 'customer_id' ? {interaction_id: ''} : {}), // reset interaction if customer changes
        }));
    };
    ...
    // Filter interactions by selected customer
            ...
            {isOpen && (<div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                    <div className="bg-slate-700 rounded-lg p-6 w-full max-w-md shadow-xl space-y-4">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3">
                            <select
                                name="type"
                                value={form.type as 'income' | 'expense'}
