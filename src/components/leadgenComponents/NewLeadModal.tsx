...
import { createLeadEntry } from "@/app/lib/services/leadServices/createLeadEntry";
...
export default function NewLeadModal({ isOpen, onClose }: NewLeadModalProps) {
  ...
  const onSubmit = async (data: LeadFormData) => {
    ...
    try {
      ...
      const success = await createLeadEntry(leadData);
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto bg-slate-900 border border-slate-700 rounded-xl shadow-2xl">
        <DialogHeader>
          ...
          <DialogDescription className="text-slate-400">
            Create a new lead entry with contact information and details.
          </DialogDescription>
        </DialogHeader>
